...
A particular version of EFE is defined as (see my [previous post](https://ran-weii.github.io/2023/07/30/active-inference-introduction.html) on different versions of active inference and formulations of EFE):
<center>
$$
